...
This repository is a Claude Skill covering the React headless component library for an AI coding agent.
...
```sh
git clone https://github.com/LilyDesignSystem/lily-design-system-react-headless-skill.git
```
